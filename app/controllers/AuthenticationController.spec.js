...
describe("AuthenticationController", () => {
  ...
  describe("#authorize", () => {
    it("should run next function if bearer token and role valid", async () => {
      const mockUser = {
        ...
        encryptedPassword: "$2a$10$YrFUwbbKdiFxmOl/RET0/eqtI3XmP0gbG0cEDOR57UsPP0ooNAILy",
        roleId: 1,
      };
  ...
  describe("#handleRegister", () => {
    it("should return res.status(201) and token if request valid", async () => {
      const mockUser = new User({
        id: 2,
        name: "nafis",
        email: "m.nafis.2001@gmail.com",
  ...
  describe("handleGetUser", () => {
    ...
    it("should res.status(404) with RecordNotFoundError " + "if user not found.", async () => {
      const mockUser = {
        id: 1,
        name: "nafis",
        email: "m.nafis.2001@gmail.com",
  ...
  describe("#verifyPassword", () => {
    it("should return true if hash and pass match", () => {
      ...
      const mockRequest = {
        body: {
          password: "$2a$10$YrFUwbbKdiFxmOl/RET0/eqtI3XmP0gbG0cEDOR57UsPP0ooNAILy",
        },
      };
